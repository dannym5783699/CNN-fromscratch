...
def friction_weight_test():
    ...
    MAX_EPOCHS = 1000
    LR = 1e-4
    friction_weights = [.1, .5, .95, .959]  # List of batch sizes to experiment with
    ...
    for friction_weight, ax in zip(friction_weights, axs.flatten()):
        ...
        print(f"Training model with frction weight {friction_weight}")
